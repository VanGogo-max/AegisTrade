...
from backend.execution.gmx_adapter import GMXAdapter
from backend.execution.dydx_adapter import DydxAdapter
from backend.execution.vertex_adapter import VertexAdapter
...
class TradingLoop:
    ...
    def __init__(self):
        ...
        self.execution_engine.register_adapter("gmx", GMXAdapter())
        self.execution_engine.register_adapter("dydx", DydxAdapter())
        self.execution_engine.register_adapter("vertex", VertexAdapter())
