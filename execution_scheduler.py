...
from execution_persistence import ExecutionPersistence, InMemoryPersistenceBackend
...
class ExecutionScheduler:
    ...
    def __init__(
        ...
        Args:
            ...
            persistence_backend: optional backend, defaults to in-memory
        ...
        # Setup persistence
        backend = persistence_backend or InMemoryPersistenceBackend()
        self.persistence = ExecutionPersistence(backend)
    ...
    def _run_loop(self) -> None:
        while not self._stop_event.is_set():
            try:
                ...
                # Scheduler-level exception logging
