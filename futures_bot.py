...
High-level coordinator for FUTURES trading logic.
"""

from typing import Optional

from types import MarketType, TradingPair
...
class FuturesBot:
    """
    Coordinates FUTURES trading by combining strategies, risk checks,
