# hyperliquid_position_tracker.py
"""
Hyperliquid Position Tracker (FINAL)

Role:
- Track lifecycle of all Hyperliquid positions
...
class HyperliquidPositionNotFound(Exception):
    pass


class HyperliquidPositionTracker:
    def __init__(self):
        self._positions: Dict[str, Dict[str, Any]] = {}

    def sync_from_exchange(self, positions: Dict[str, Dict[str, Any]]) -> None:
        """
        Replace local state with fresh snapshot from Hyperliquid API.
        """
    ...
    def _get(self, position_id: str) -> Dict[str, Any]:
        if position_id not in self._positions:
            raise HyperliquidPositionNotFound(position_id)
