...
class MarketDataAggregator:
    def __init__(self, price_feed, funding_feed=None, oi_feed=None, volatility_feed=None):
        """
        Feeds should implement simple interfaces:
        - price_feed.get_price(market)
        - funding_feed.get_funding(market)
        - oi_feed.get_oi(market)
        - volatility_feed.get_volatility(market)
        """
    ...
    def snapshot(self, market: str) -> Dict[str, Any]:
        """
        Returns a unified market data snapshot for a single market
        """
        data = {
            "market": market,
